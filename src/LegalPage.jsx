...
function Privacy() {
  return (
    <>
      ...
      <p><strong>Your profile.</strong> The name you want shown, your school, your board's colours and fonts, the short web address you choose for your board, and a home-screen photo if you add one. If we recognize your school district from your email domain, we may fill in its colours, school list and quick links for you.</p>
